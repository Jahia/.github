...
> 
> **AI agent:** Delegate the first review to a [Security architect agent](https://github.com/msitarzewski/agency-agents/blob/main/security/security-architect.md) with a prompt similar to this:
