...
- [ ] ⚠️ If the module has a dependency to [graphql-core](https://github.com/Jahia/graphql-core), [server-availability-manager](https://github.com/Jahia/server-availability-manager), [personal-api-tokens](https://github.com/Jahia/personal-api-tokens) syn-cup with the Cloud team before moving forward with the publication
